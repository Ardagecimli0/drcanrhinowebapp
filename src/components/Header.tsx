...
export default function Header() {
  ...
  return (
    <header
      ...
      style={{
        backgroundColor: isScrolled ? 'rgba(30, 32, 41, 0.98)' : 'rgba(30, 32, 41, 0.85)',
    ...
    >
      ...
      >
        {/* Logo */}
        <div className="flex px-2 md:items-center gap-3 shrink-0">
          <Image
            src="/images/logo-kalkavan.png"
            alt="Dr. Can Kalkavan Logo"
            width={280}
            height={90}
            className={`transition-all duration-300 object-contain ${isScrolled ? 'h-16 w-auto lg:h-20' : 'h-[85px] w-auto lg:h-24'}`}
          />
        </div>
        ...
        >
          {/* Mobile View: Only "Free Consultation" text */}
          <span className="block lg:hidden">{t("common.freeConsultation")}</span>

          {/* Desktop View: Icon + "Contact Us Now for Rhinoplasty!" */}

...
const roles = [
  ...
  },
  {
    ...
    description: "Oil Painting, Classical and Abstract Works...",
  },
  {
    title: "Author",
    description: "Nose, Breast, Lip Art Book Author, Elle, Vogue, CNNTurk",
  },
];
    ...
    <section className="py-16 bg-gradient-to-b from-[#1c2530] to-[#151b23]">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="max-w-md mx-auto mb-12">
          <Image
            src="https://ext.same-assets.com/3003609744/3240817059.png"
            alt="Dr. Can Kalkavan"
            width={400}
            height={400}
        ...
        <div className="text-center">
          <p className="text-xl text-white mb-2">
            Plan your rhinoplasty journey with
          </p>

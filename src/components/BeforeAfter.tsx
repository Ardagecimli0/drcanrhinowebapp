...
const beforeAfterImages = [
  "https://ext.same-assets.com/3003609744/2852885239.png",
  "https://ext.same-assets.com/3003609744/2438337819.png",
  "https://ext.same-assets.com/3003609744/4249987684.png",
  "https://ext.same-assets.com/3003609744/2973170756.png",
  "https://ext.same-assets.com/3003609744/706815662.png",
  "https://ext.same-assets.com/3003609744/1324354865.png",
];
            ...
            {beforeAfterImages.map((_, index) => (
              <button
                ...
                className={`w-2 h-2 rounded-full transition ${
                  currentSlide === index ? "bg-[#c9a96e]" : "bg-gray-600"
                }`}
